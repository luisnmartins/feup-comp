    ...
    if(this.functionCalled == null) {
        ...
        if (arg.isID) {
            ...
            if ((entrySymbol = parent.getFromAll(arg.value)) == null) {
                ...
                if (!entrySymbol.isInitialized() || entrySymbol.isArray() != symbol.isArray()) {
                  throw new ParseException(this, "There was a problem calling function '" + name
            ...
            if (symbol.isArray()) {
              throw new ParseException(this, "There was a problem calling function " + name + ":expected array received " + arg.value);
      ...
      for(int i=0; i<this.jjtGetNumChildren(); i++) {
        ...
        if(arg.isID && ((entrySymbol = parent.getFromAll(arg.value)) == null || !entrySymbol.isInitialized())){
          throw new ParseException(this, "There was a problem calling function '" + functionCalled + "' on the parameter '" + arg.value + "':wrong type or not initialized");
        }
      }
